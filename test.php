...
<title>...</title>
<link type="image/x-icon" rel="icon" href="content/sys/" />
<link rel="stylesheet" type="text/css" media="all"  href="system/css/dommon.css" />
<script type="text/javascript" src="system/js/voodi.js"></script>
<body>
...
if (isset($_SESSION['user_id'])) {
				 echo'
			<div class=""><a><span id="cab" class="mf_t"><img src=""></span></a></div><!-- Корзина -->
...
<div id="pages_bottom" >
	<div>
		<a class="podol_n" href="/">© name </a> |
		<a class="podol_n" href="/about">About</a> |
		<a class="podol_n" href="/blog">blog</a> |
		<a class="podol_n" href="/support">help</a> |
		<a class="podol_n" href >Donate</a> |
		<a class="podol_n" href="/support/14">Copyright</a>
	</div>
</div>
</body>